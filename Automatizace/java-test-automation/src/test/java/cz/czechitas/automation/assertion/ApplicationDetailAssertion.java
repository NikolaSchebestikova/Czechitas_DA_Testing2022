...
public final class ApplicationDetailAssertion {
    ...
    public void overKrestniJmenoZaka (String KrestniJmenoZaka) {
        var nameElement = elementFinder.findByXPath("//*[@id=\"forename\"]");
        assertThat(nameElement.getText()).isEqualTo(KrestniJmenoZaka);
    }
    public void overExistenciSloupce(String jmenoSloupce) {
        var buttonName = elementFinder.findByXPath("/html/body/div/div/div/div/div/div[2]/div[2]/div/table/thead/tr");
        assertThat(buttonName.getText()).isEqualTo(jmenoSloupce);
    }
